...
| Safe local installation and lifecycle | Native macOS/Linux transient lifecycle CI; bundle boundary tests | Persistent service installer, clean-machine upgrades, login/reboot behavior |
